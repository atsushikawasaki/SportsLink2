...
export default function ResetPasswordPage() {
    ...
    // Note: Supabase Auth automatically sets session when user clicks reset link
    // Session is handled by cookies, no token needed in request body
            ...
            <div className="w-full max-w-md p-8">
                <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/50 p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-400 mt-2">新しいパスワードを入力してください</p>
                    </div>
                        ...
                        <div className="space-y-6">
                            <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                                <p className="text-sm text-green-400">
                                    パスワードをリセットしました。ログイン画面にリダイレクトします...
                                </p>
                            </div>
                        </div>
                    ) : (
